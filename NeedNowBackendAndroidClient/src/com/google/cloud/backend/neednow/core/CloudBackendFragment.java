...
import com.google.cloud.backend.neednow.core.CloudBackendFragment.OnListener;
import com.google.cloud.backend.neednow.core.CloudEntity;
import com.google.cloud.backend.neednow.core.Consts;
import com.google.cloud.backend.neednow.GCMIntentService;
...
public class CloudBackendFragment extends Fragment {
	...
	private CloudBackendAsync mCloudBackend;
	 ...
	 * token = intent.getStringExtra("token"); Log.i(Consts.TAG,
	 * "A message has been recieved of token: " + token);
	...
	public CloudBackendAsync getCloudBackend() {
	 ...
	 * super.onAttach(activity); try { callback = (OnListener) activity; } catch
	 * (ClassCastException e) { throw new ClassCastException(activity.toString()
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// create credential
		mCredential = GoogleAccountCredential.usingAudience(getActivity(),
	...
	public void signInAndSubscribe(boolean overrideCurrent) {
		if (Consts.IS_AUTH_ENABLED) {
			String accountName = mCloudBackend.getSharedPreferences()
	...
	public final void onActivityResult(int requestCode, int resultCode,
		...
		case REQUEST_ACCOUNT_PICKER:
			if (data != null && data.getExtras() != null) {
				...
				SharedPreferences.Editor e = mCloudBackend
	...
	protected String getAccountName() {
		return mCredential == null ? null : mCredential
