...
public class CloudBackend {
	...
	public Mobilebackend getMBSEndpoint() {
		...
		final GoogleAccountCredential gac = mCredential == null
				|| mCredential.getSelectedAccountName() == null ? null
				: mCredential;
		...
		return new Mobilebackend.Builder(AndroidHttp.newCompatibleTransport(),
				new GsonFactory(), hri).setRootUrl(Consts.ENDPOINT_ROOT_URL)
				.build();
	}
	...
	public CloudEntity insert(CloudEntity ce) throws IOException {
		...
		CloudEntity resultCo = CloudEntity
				.createCloudEntityFromEntityDto(resultEntityDto);
	 ...
	 *             When the call had failed for any reason.
	 */
	public List<CloudEntity> insertAll(List<CloudEntity> ceList)
			throws IOException {
	 ...
	 *             When the call had failed for any reason.
	 */
	public List<CloudEntity> updateAll(List<CloudEntity> coList)
			throws IOException {
	...
	public CloudEntity get(String kindName, String id) throws IOException {
		EntityDto cd = getMBSEndpoint().endpointV1().get(kindName, id)
				.execute();
	 ...
	 *             When the call had failed for any reason.
	 */
	public List<CloudEntity> getAll(String kindName, List<String> idList)
			throws IOException {
	...
	private EntityListDto createEntityListDto(String kindName,
			List<String> idList) {
	...
	public void delete(CloudEntity co) throws IOException {
		getMBSEndpoint().endpointV1().delete(co.getKindName(), co.getId())
				.execute();
	 ...
	 *             When the call had failed for any reason.
	 */
	public void deleteAllById(String kindName, List<String> idList)
			throws IOException {
	 ...
	 *             When the call had failed for any reason.
	 */
	public void deleteAll(String kindName, List<CloudEntity> coList)
			throws IOException {
